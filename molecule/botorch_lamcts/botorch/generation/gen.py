...
def gen_candidates_scipy(
    ...
    def f(x):
        ...
        # print('loss by acq_func is', loss)
    ...
    if not torch.cuda.is_available():
        ub = upper_bounds.data.numpy()
        lb = lower_bounds.data.numpy()
    else:
        ub = upper_bounds.cpu().data.numpy()
        lb = lower_bounds.cpu().data.numpy()
    ...
    # print('clamped_candidates is', clamped_candidates)
    # print('batch_acquisition is', batch_acquisition)
