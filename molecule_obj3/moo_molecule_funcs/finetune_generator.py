...
class Chemprop(object):
        ...
        for root, _, files in os.walk(checkpoint_dir):
            for fname in files:
                if fname.endswith('.pt'):
                    ...
                    print('fnname is=============', fname)
                    print('load_scalers(fname) is==============', load_scalers(fname))
                    (scaler, features_scaler, a, b) = load_scalers(fname)
    ...
    def predict(self, smiles, batch_size=500):
        ...
        test_data_loader = MoleculeDataLoader(dataset=test_data, batch_size=batch_size, num_workers=0)
