...
class MCTS:
    ...
    def init_train(self):
        ...
        if not torch.cuda.is_available():
            data = torch.load('nasbench201_std_normalized_data.pt', map_location=torch.device('cpu'))
        else:
            data = torch.load('nasbench201_std_normalized_data.pt')
